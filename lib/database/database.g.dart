...
class $BillsTable extends Bills with TableInfo<$BillsTable, Bill> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, distributorId, billNumber, billDate, amountPaise, notes, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Payment extends DataClass implements Insertable<Payment> {
  ...
  @override
  int get hashCode => Object.hash(id, billId, paymentDate, amountPaise, mode,
      referenceNo, notes, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Payment &&
...
abstract class _$BillMedDatabase extends GeneratedDatabase {
  ...
  late final Index idxBillsDistributor = Index('idx_bills_distributor',
      'CREATE INDEX idx_bills_distributor ON bills (distributor_id)');
  late final Index idxBillsBillDate = Index('idx_bills_bill_date',
      'CREATE INDEX idx_bills_bill_date ON bills (bill_date)');
  late final Index idxPaymentsBill = Index('idx_payments_bill',
      'CREATE INDEX idx_payments_bill ON payments (bill_id)');
  late final Index idxPaymentsPaymentDate = Index('idx_payments_payment_date',
